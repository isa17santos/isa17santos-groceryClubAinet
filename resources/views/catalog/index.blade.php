...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
    <h1 class="text-4xl font-bold text-center text-yellow-700 dark:text-yellow-700 mb-10">Product Catalog</h1>

    <form method="GET" action="{{ route('catalog') }}" class="mb-8 bg-white dark:bg-gray-800 p-5 rounded-lg shadow flex flex-col lg:flex-row lg:items-end gap-6 w-full">
    ...
    <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-2xl overflow-hidden hover:shadow-2xl transition
            ...
            <div class="p-4">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-300">{{ $product->category->name ?? 'Sem categoria' }}</p>
        ...
        @empty
        <div class="col-span-full text-center text-gray-600 dark:text-gray-300 text-lg py-10">
